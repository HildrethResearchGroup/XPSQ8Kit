...
public extension XPSQ8Controller.GroupController {
  /**
   ...
   This name should be set in the XPS hardward controller softare.  An example name would be: "MacroStages.X", where "MacroStages" is the name of the group that the stage belongs to while "X" is the name of the specific stage you want to move.
  ...
  /**
   ...
   - parameters:
   - name: The name of the stage that will be moved.
  ...
  /**
   ...
   do {
   try controller?.group.searchForHome(group: "M")
  ...
  /**
   ...
   ````
   */
  func getMotionStatus(stageOrGroupName name: String) throws -> Stage.MotionStatus {
