...
public extension Stage {
  ...
  /// ````
  var currentJog: (velocity: Double, acceleration: Double) {
    get throws {
      try stageGroup.currentJog(for: self)
    }
  }
  ...
  var jogParameters: (velocity: Double, acceleration: Double) {
    get throws {
      try stageGroup.jogParameters(for: self)
    }
  }
}
